...
public class DemoController {
    ...
    @PutMapping("/cardapio/atualizar")
    public ResponseEntity<List<CardapioDTO>> updateRefeicoes(@RequestBody List<CardapioDTO> updates) {
        updates = updates.stream()
            .filter(cardapio -> cardapio != null)
            .toList();
        service.updateCardapio(updates);
